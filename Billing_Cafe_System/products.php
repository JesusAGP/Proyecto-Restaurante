							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										...
										<p><small>Estatus: <b><?php echo $row['status'] == 1 ? " Disponible" : "Agotado" ?></b></small></p>
										<p><small>Descripcion: <b><?php echo $row['description'] ?></b></small></p>
										<p><small>ID: <b><?php echo $row['id'] ?></b></small></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_product" type="button" data-id="<?php echo $row['id'] ?>" data-description="<?php echo $row['description'] ?>" data-name="<?php echo $row['name'] ?>"  data-price="<?php echo $row['price'] ?>"  data-status="<?php echo $row['status'] ?>" data-category_id="<?php echo $row['category_id'] ?>">Editar</button>
