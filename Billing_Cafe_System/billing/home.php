        ...
        <div class="col-lg-8  p-field">
            ...
            <div class="card-footer bg-dark  border-primary">
                ...
                <div class="row justify-content-left">
                    <div>
                	    <form action="http://localhost/Tick-Restaurant/orden-confirmada.php" method="post" enctype="multipart/form-data">
                            <button class="btn btn-success" type="submit"> Confirmar orden</button></br>
                        </form>
                    </div>
                    <div>
                        <form action="http://localhost/Tick-Restaurant/orden-cancelada.php" method="post" enctype="multipart/form-data">
